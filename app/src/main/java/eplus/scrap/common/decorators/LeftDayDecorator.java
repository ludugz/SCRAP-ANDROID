 ...
 */
public class LeftDayDecorator extends DayViewDecorator {
    ...
    public LeftDayDecorator(SearchFragment context) {
        date = CalendarDay.today();
        drawable = context.getResources().getDrawable(R.drawable.left_date_range_circle);
    }
