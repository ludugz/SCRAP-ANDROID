package eplus.scrap.common.WeekCalendar.view;
...
import eplus.scrap.common.WeekCalendar.adapter.PagerAdapter;
...
public class WeekPager extends ViewPager {
    ...
    public WeekPager(Context context, AttributeSet attrs,ArrayList<Date> days) {
        super(context, attrs);
        initialize(attrs);
        this.days = days;
    }
    ...
    private void initPager(DateTime dateTime) {
        ...
        adapter = new PagerAdapter(((AppCompatActivity) getContext())
                .getSupportFragmentManager(), dateTime,days);
        setAdapter(adapter);
