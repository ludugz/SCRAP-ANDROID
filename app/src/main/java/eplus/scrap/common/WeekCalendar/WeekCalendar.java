...
import eplus.scrap.common.WeekCalendar.decorator.DayDecorator;
import eplus.scrap.common.WeekCalendar.decorator.DefaultDayDecorator;
import eplus.scrap.common.WeekCalendar.eventbus.BusProvider;
import eplus.scrap.common.WeekCalendar.eventbus.Event;
import eplus.scrap.common.WeekCalendar.listener.OnDateClickListener;
import eplus.scrap.common.WeekCalendar.listener.OnWeekChangeListener;
import eplus.scrap.common.WeekCalendar.view.WeekPager;
...
public class WeekCalendar extends LinearLayout {
    ...
    public WeekCalendar(Context context, AttributeSet attrs,ArrayList<Date> days) {
        super(context, attrs);
        init(attrs,days);

    }

    public WeekCalendar(Context context, AttributeSet attrs, int defStyleAttr,ArrayList<Date> days) {
        super(context, attrs, defStyleAttr);
        init(attrs,days);

    }

    private void init(AttributeSet attrs,ArrayList<Date> days) {
        if (attrs != null) {
        ...
        WeekPager weekPager = new WeekPager(getContext(), attrs,days);
        addView(weekPager);
