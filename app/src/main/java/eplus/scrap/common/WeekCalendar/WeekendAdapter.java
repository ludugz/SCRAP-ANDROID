...
public class WeekendAdapter extends RecyclerView.Adapter<WeekendAdapter.SimpleViewHolder> {
    private ArrayList<Date> days;
    private Context context;
    private static ClickListener clickListener;
    int selectedPosition=0;

    public WeekendAdapter(Context context, ArrayList<Date> days, int pos){
    ...
    public void setOnItemClickListener(ClickListener clickListener) {
        WeekendAdapter.clickListener = clickListener;
    }
