...
import eplus.scrap.calendarview2.format.ArrayWeekDayFormatter;
import eplus.scrap.calendarview2.format.DateFormatTitleFormatter;
import eplus.scrap.calendarview2.format.DayFormatter;
import eplus.scrap.calendarview2.format.MonthArrayTitleFormatter;
import eplus.scrap.calendarview2.format.TitleFormatter;
import eplus.scrap.calendarview2.format.WeekDayFormatter;
...
public class CalendarView2 extends ViewGroup {
    ...
    /**
     * Set a {@linkplain eplus.scrap.calendarview2.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see eplus.scrap.calendarview2.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(eplus.scrap.calendarview2.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain eplus.scrap.calendarview2.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see eplus.scrap.calendarview2.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(eplus.scrap.calendarview2.format.TitleFormatter)
     */
