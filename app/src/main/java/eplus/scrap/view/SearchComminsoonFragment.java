 ...
 */
public class SearchComminsoonFragment extends Fragment {
    ...
    public SearchComminsoonFragment() {
        // Required empty public constructor
    }
    public static SearchComminsoonFragment newInstance(OnCompleteListener listener,String keyword, long fromdate, long todate) {
        SearchComminsoonFragment fragment = new SearchComminsoonFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_search_comminsoon, container, false);
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                searchtours(null,"",CommonFunc.getDate(mFromDate,"yyyy/MM/dd"),CommonFunc.getDate(mToDate,"yyyy/MM/dd"),mKeyword,"coming_soon",false);
            }
        });
        if(CommonFunc.isNetworkConnected(getActivity())) {
            ...
            if (eventArrayLists != null && eventArrayLists.size() > 0) {
                ...
                searchtours(null, "", CommonFunc.getDate(mFromDate, "yyyy/MM/dd"), CommonFunc.getDate(mToDate, "yyyy/MM/dd"), mKeyword, "coming_soon", true);
        } else {
            ...
            public void onBottomReached() {
                if (pagination != null) {
                    if (pagination.getPage()  * 10 <= pagination.getTotal_items() && isLoadMore) {
                        searchtourmore("", "", CommonFunc.getDate(mFromDate, "yyyy/MM/dd"), CommonFunc.getDate(mToDate, "yyyy/MM/dd"), mKeyword, "coming_soon",false);
    ...
    private void searchtours(String lang_code, String specify_date, String date_from, String date_to, String key_word, String show_type, boolean loading ) {
        ...
        //tntan92
        BaseRestClient.getRetrofit(getActivity(),SEARCH_TOUR_URL,param,responseVeryfy,loading);
    }
